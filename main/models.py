...
from .utils import user_listing_directory_path
...
class Listing(models.Model):
    ...
    image = models.ImageField(upload_to=user_listing_directory_path)
    
    def __str__(self):
        return f'{self.seller.users.username} \'s Listing - {self.model}'
...
class LikedListing(models.Model):
    ...
    def __str__(self):
        return f'{self.listing.model} listing liked by {self.profile.users.username}'